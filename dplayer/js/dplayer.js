!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("fsdmplayer", [], t) : "object" == typeof exports ? exports.fsdmplayer = t() : e.fsdmplayer = t()
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            var t = ""
              ...
              , u = e.url
              , n = a && "webvtt" === a.type;
            return t += '\n<video\n id="fsdmvideo"\n    class="fsdmplayer-video ',
            o && (t += "fsdmplayer-video-current"),
        ...
        var o = function() {
          ...
          , Y = function() {
            function e(t) {
                ...
                this.container.classList.add("fsdmplayer"),
                this.options.danmaku || this.container.classList.add("fsdmplayer-no-danmaku"),
                this.options.live && this.container.classList.add("fsdmplayer-live"),
                c.default.isMobile && this.container.classList.add("fsdmplayer-mobile"),
                this.arrow = this.container.offsetWidth <= 500,
                this.arrow && this.container.classList.add("fsdmplayer-arrow"),
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("fsdmplayer-paused"),
                    this.container.classList.add("fsdmplayer-playing"),
                ...
                value: function() {
                    this.paused = !0,
                    this.container.classList.remove("fsdmplayer-loading"),
                    ...
                    this.container.classList.remove("fsdmplayer-playing"),
                    this.container.classList.add("fsdmplayer-paused"),
                        ...
                        case "webtorrent":
                            if (WebTorrent)
                                if (WebTorrent.WEBRTC_SUPPORT) {
                                    this.container.classList.add("fsdmplayer-loading");
                                    ...
                                    o.add(s, function(e) {
                                        e.files.find(function(e) {
                                            ...
                                            n.container.classList.remove("fsdmplayer-loading")
                                        })
                                    })
                                } else
                    ...
                    if (this.qualityIndex !== e && !this.switchingQuality) {
                        ...
                        this.on("canplay", function() {
                            if (t.prevVideo) {
                                ...
                                t.video.classList.add("fsdmplayer-video-current"),
                                n || t.video.play(),
                                t.prevVideo = null,
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            var t = {
                container: e.element || document.getElementsByClassName("fsdmplayer")[0],
                live: !1,
                autoplay: !1,
                theme: "#b7daff",
                loop: !1,
            ...
            "object" === i(e.danmaku) && e.danmaku && !e.danmaku.user && (e.danmaku.user = ""),
            ...
            e.contextmenu = e.contextmenu.concat([{
                ...
                text: config.contextmenu,
                link: config.contextlink,
                tzym: "_blank"
            }]),
            e
        }
          ...
          , u = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    this.volumeBar = this.container.querySelector(".fsdmplayer-volume-bar-inner"),
                    this.volumeBarWrap = this.container.querySelector(".fsdmplayer-volume-bar"),
                    this.volumeBarWrapWrap = this.container.querySelector(".fsdmplayer-volume-bar-wrap"),
                    this.volumeButton = this.container.querySelector(".fsdmplayer-volume"),
                    this.volumeIcon = this.container.querySelector(".fsdmplayer-volume-icon .fsdmplayer-icon-content"),
                    this.playedBar = this.container.querySelector(".fsdmplayer-played"),
                    this.loadedBar = this.container.querySelector(".fsdmplayer-loaded"),
                    this.playedBarWrap = this.container.querySelector(".fsdmplayer-bar-wrap"),
                    this.playedBarTime = this.container.querySelector(".fsdmplayer-bar-time"),
                    this.danmaku = this.container.querySelector(".fsdmplayer-danmaku"),
                    this.danmakuLoading = this.container.querySelector(".fsdmplayer-danloading"),
                    this.video = this.container.querySelector(".fsdmplayer-video-current"),
                    this.bezel = this.container.querySelector(".fsdmplayer-bezel-icon"),
                    this.playButton = this.container.querySelector(".fsdmplayer-play-icon"),
                    this.videoWrap = this.container.querySelector(".fsdmplayer-video-wrap"),
                    this.controllerMask = this.container.querySelector(".fsdmplayer-controller-mask"),
                    this.ptime = this.container.querySelector(".fsdmplayer-ptime"),
                    this.settingButton = this.container.querySelector(".fsdmplayer-setting-icon"),
                    this.settingBox = this.container.querySelector(".fsdmplayer-setting-box"),
                    this.mask = this.container.querySelector(".fsdmplayer-mask"),
                    this.loop = this.container.querySelector(".fsdmplayer-setting-loop"),
                    this.loopToggle = this.container.querySelector(".fsdmplayer-setting-loop .fsdmplayer-toggle-setting-input"),
                    this.showDanmaku = this.container.querySelector(".fsdmplayer-setting-showdan"),
                    this.showDanmakuToggle = this.container.querySelector(".fsdmplayer-showdan-setting-input"),
                    this.unlimitDanmaku = this.container.querySelector(".fsdmplayer-setting-danunlimit"),
                    this.unlimitDanmakuToggle = this.container.querySelector(".fsdmplayer-danunlimit-setting-input"),
                    this.speed = this.container.querySelector(".fsdmplayer-setting-speed"),
                    this.speedItem = this.container.querySelectorAll(".fsdmplayer-setting-speed-item"),
                    this.danmakuOpacityBar = this.container.querySelector(".fsdmplayer-danmaku-bar-inner"),
                    this.danmakuOpacityBarWrap = this.container.querySelector(".fsdmplayer-danmaku-bar"),
                    this.danmakuOpacityBarWrapWrap = this.container.querySelector(".fsdmplayer-danmaku-bar-wrap"),
                    this.danmakuOpacityBox = this.container.querySelector(".fsdmplayer-setting-danmaku"),
                    this.dtime = this.container.querySelector(".fsdmplayer-dtime"),
                    this.controller = this.container.querySelector(".fsdmplayer-controller"),
                    this.commentInput = this.container.querySelector(".fsdmplayer-comment-input"),
                    this.commentButton = this.container.querySelector(".fsdmplayer-comment-icon"),
                    this.fsdmcomment = this.container.querySelector(".fsdm-fsdmplayer-comment-input"),
                    this.commentSettingBox = this.container.querySelector(".fsdmplayer-comment-setting-box"),
                    this.commentSettingButton = this.container.querySelector(".fsdmplayer-comment-setting-icon"),
                    this.commentSettingFill = this.container.querySelector(".fsdmplayer-comment-setting-icon path"),
                    this.commentSendButton = this.container.querySelector(".fsdmplayer-send-icon"),
                    this.commentSendFill = this.container.querySelector(".fsdmplayer-send-icon path"),
                    this.commentColorSettingBox = this.container.querySelector(".fsdmplayer-comment-setting-color"),
                    this.browserFullButton = this.container.querySelector(".fsdmplayer-full-icon"),
                    this.webFullButton = this.container.querySelector(".fsdmplayer-full-in-icon"),
                    this.menu = this.container.querySelector(".fsdmplayer-menu"),
                    this.menuItem = this.container.querySelectorAll(".fsdmplayer-menu-item"),
                    this.qualityList = this.container.querySelector(".fsdmplayer-quality-list"),
                    this.camareButton = this.container.querySelector(".fsdmplayer-camera-icon"),
                    this.subtitleButton = this.container.querySelector(".fsdmplayer-subtitle-icon"),
                    this.subtitleButtonInner = this.container.querySelector(".fsdmplayer-subtitle-icon .fsdmplayer-icon-content"),
                    this.subtitle = this.container.querySelector(".fsdmplayer-subtitle"),
                    this.qualityButton = this.container.querySelector(".fsdmplayer-quality-icon"),
                    this.barPreview = this.container.querySelector(".fsdmplayer-bar-preview"),
                    this.barWrap = this.container.querySelector(".fsdmplayer-bar-wrap"),
                    this.notice = this.container.querySelector(".fsdmplayer-notice"),
                    this.infoPanel = this.container.querySelector(".fsdmplayer-info-panel"),
                    this.infoPanelClose = this.container.querySelector(".fsdmplayer-info-panel-close"),
                    this.infoVersion = this.container.querySelector(".fsdmplayer-info-panel-item-version .fsdmplayer-info-panel-item-data"),
                    this.infoFPS = this.container.querySelector(".fsdmplayer-info-panel-item-fps .fsdmplayer-info-panel-item-data"),
                    this.infoType = this.container.querySelector(".fsdmplayer-info-panel-item-type .fsdmplayer-info-panel-item-data"),
                    this.infoUrl = this.container.querySelector(".fsdmplayer-info-panel-item-url .fsdmplayer-info-panel-item-data"),
                    this.infoResolution = this.container.querySelector(".fsdmplayer-info-panel-item-resolution .fsdmplayer-info-panel-item-data"),
                    this.infoDuration = this.container.querySelector(".fsdmplayer-info-panel-item-duration .fsdmplayer-info-panel-item-data"),
                    this.infoDanmakuId = this.container.querySelector(".fsdmplayer-info-panel-item-danmaku-id .fsdmplayer-info-panel-item-data"),
                    this.infoDanmakuApi = this.container.querySelector(".fsdmplayer-info-panel-item-danmaku-api .fsdmplayer-info-panel-item-data"),
                    this.infoDanmakuAmount = this.container.querySelector(".fsdmplayer-info-panel-item-danmaku-amount .fsdmplayer-info-panel-item-data")
                }
            }]),
            e
        }();
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.$value,
            e.$index;
            return t += '<div class="fsdmplayer-mask"></div><div class="fixed"></div><div id="fsdmzdy" class="fsdmzdycss"></div>\n<div class="fsdmplayer-cplayer"><div class="fsdmplayer-showing"><svg aria-hidden="true"><use xlink:href="#icon-play"></use></svg></div><div class="vod-title"><div id="landing-title" class="video-info"><ul class="u-title"><a id="vodlink" href="" target="_blank" ><span class="iconfont icon-back"></span></a><a id="vodtitle"><span></span></a></ul></div></div></div><div class="fsdmplayer-video-wrap">\n    ',
            function(e) {
                t += e
            }(n(4)(a)),
            t += "\n    ",
            o.logo && (t += '\n    <div class="fsdmplayer-logo">\n        <img src="',
            t += s(o.logo),
            t += '">\n    </div>\n    '),
            t += '\n    <div class="fsdmplayer-danmaku"',
            o.danmaku && o.danmaku.bottm && (t += ' style="margin-bottom:',
            t += s(o.danmaku.bottm),
            t += '"'),
            t += '>\n        <div class="fsdmplayer-danmaku-item fsdmplayer-danmaku-item--demo"></div>\n    </div>\n    <div class="fsdmplayer-subtitle"></div>\n    <div class="fsdmplayer-bezel">\n        <span class="fsdmplayer-bezel-icon"></span>\n        ',
            o.danmaku && (t += '\n        <span class="fsdmplayer-danloading">',
            t += "</span>\n        "),
            t += '\n        <span class="diplayer-loading-icon">',
            t += l.loading,
            t += '</span>\n    </div>\n</div>\n<div class="fsdmplayer-controller-mask"></div>\n<div class="fsdmplayer-controller">\n  <div class="controller-box">\n   <div class="fsdmplayer-icons fsdmplayer-icons-left">\n        <button class="fsdmplayer-icon fsdmplayer-play-icon" id="bofang">\n            <span class="fsdmplayer-icon-content">',
            t += l.play,
            t += '</span>\n        </button>\n    <button onclick="fosi.next();" class="fsdmplayer-icon  icon-xj" data-balloon="下一集" data-balloon-pos="up">\n<span class="fsdmplayer-icon-content"><svg aria-hidden="true" fill="#fff"><use xlink:href="#icon-play-xj"></use></svg></span></button>\n    <div class="fsdmplayer-volume">\n            <button class="fsdmplayer-icon fsdmplayer-volume-icon">\n                <span class="fsdmplayer-icon-content">',
            t += l.volumeDown,
            t += '</span>\n            </button>\n            <div class="fsdmplayer-volume-bar-wrap" data-balloon-pos="up">\n                <div class="fsdmplayer-volume-bar">\n                    <div class="fsdmplayer-volume-bar-inner" style="background: ',
            t += s(o.theme),
            t += ';">\n                        <span class="fsdmplayer-thumb" style="background: ',
            t += s(o.theme),
            t += '"></span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <span class="fsdmplayer-time">\n            <span class="fsdmplayer-ptime">0:00</span> /\n            <span class="fsdmplayer-dtime">0:00</span>\n        </span>\n        ',
            o.live && (t += '\n        <span class="fsdmplayer-live-badge"><span class="fsdmplayer-live-dot" style="background: ',
            t += s(o.theme),
            t += ';"></span>',
            t += s(r("Live")),
            t += "</span>\n        "),
            t += '\n    </div>\n    <div class="fsdmplayer-icons fsdmplayer-icons-right">\n        ',
            o.video.quality && (t += '\n        <div class="fsdmplayer-quality">\n            <button class="fsdmplayer-icon fsdmplayer-quality-icon">',
            t += s(o.video.quality[o.video.defaultQuality].name),
            t += '</button>\n            <div class="fsdmplayer-quality-mask">\n                <div class="fsdmplayer-quality-list"></div>\n                ',
            u(o.video.quality, function(e, n) {
                t += '\n                    <div class="fsdmplayer-quality-item" data-index="',
                t += s(n),
                t += '">',
                t += s(e.name),
                t += "</div>\n                "
            ...
            t += '" value="bottom">\n                    <span>',
            t += s(r("Bottom")),
            t += '</span>\n                </label>\n            </div>\n    <div class="fsdmplayer-comment-setting-font"><div class="fsdmplayer-comment-setting-title">弹幕大小</div><label><input type="radio"name="fsdmplayer-danmaku-font-0"value="50px"><span>超大</span></label><label><input type="radio"name="fsdmplayer-danmaku-font-0"value="30px"><span>较大</span></label><label><input type="radio"name="fsdmplayer-danmaku-font-0"value="25px"checked=""><span>标准</span></label><label><input type="radio"name="fsdmplayer-danmaku-font-0"value="18px"><span>较小</span></label></div>      <div class="fsdmplayer-comment-setting-color">\n                <div class="fsdmplayer-comment-setting-title">',
            t += s(r("Set danmaku color")),
            t += '</div>\n                <label>\n                    <input type="radio" name="fsdmplayer-danmaku-color-',
            t += s(c),
            ...
            t += s(c),
            t += '" value="#FFFFFF" checked>\n                    <span style="background: #FFFFFF"></span>\n                </label>\n</div>\n                   </div>\n        <input class="fsdmplayer-comment-input" type="text" placeholder="',
            t += s(r("Input danmaku, hit Enter")),
            t += '" maxlength="30">\n        <button class="fsdmplayer-icon fsdmplayer-send-icon" data-balloon="',
            t += s(r("Send")),
            t += '" data-balloon-pos="up">\n            <span class="fsdmplayer-icon-content">',
            t += l.send,
            t += '</span>\n        </button>\n<input id="dmtext" dmtype="right" size="27.5px" class="fsdm-fsdmplayer-comment-input" type="text" placeholder="',
            t += s(r("Input danmaku, hit Enter")),
            t += '" maxlength="30" autocomplete="off" >\n        <button class="fsdmplayer-icon fsdm-fsdmplayer-send-icon"  data-balloon-pos="up">发送	</button>\n   </div>\n  </div>\n<div class="fsdmplayer-info-panel fsdmplayer-info-panel-hide">\n    <div class="fsdmplayer-info-panel-close">关闭</div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-version">\n        <span class="fsdmplayer-info-panel-item-title">播放器版本</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-fps">\n        <span class="fsdmplayer-info-panel-item-title">播放器帧率</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-type">\n        <span class="fsdmplayer-info-panel-item-title">视频类型</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-url">\n        <span class="fsdmplayer-info-panel-item-title">视频地址</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-resolution">\n        <span class="fsdmplayer-info-panel-item-title">视频分辨率</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-duration">\n        <span class="fsdmplayer-info-panel-item-title">视频时长</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    ',
            o.danmaku && (t += '\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-danmaku-id">\n        <span class="fsdmplayer-info-panel-item-title">弹幕 ID</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-danmaku-api">\n        <span class="fsdmplayer-info-panel-item-title">弹幕API</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n    <div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-danmaku-amount">\n        <span class="fsdmplayer-info-panel-item-title">弹幕数量</span>\n        <span class="fsdmplayer-info-panel-item-data"></span>\n    </div>\n<div class="fsdmplayer-info-panel-item fsdmplayer-info-panel-item-title-amount"><span class="fsdmplayer-info-panel-item-title">视频标题</span><span class="fsdmplayer-info-panel-item-data" id="vod-title"></span></div>\n    '),
            t += '\n</div>\n<div class="fsdmplayer-menu">\n    ',
            u(o.contextmenu, function(e, n) {
                t += '\n        <div class="fsdmplayer-menu-item">\n            <a target="',
                t += s(e.tzym || "_self"),
                t += '" href="',
        ...
        : function(e) {
          ...
          , s = function() {
            ...
            return o(e, [{
                ...
                value: function(e) {
                    if (void 0 !== e) {
                        for (var t = this.container.getElementsByClassName("fsdmplayer-danmaku-item"), n = 0; n < t.length; n++)
                            t[n].style.opacity = e;
                        this._opacity = e,
                    ...
                    if (this.showing) {
                        ...
                        for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++)
                            !function(a) {
                                ...
                                o.classList.add("fsdmplayer-danmaku-item"),
                                o.classList.add("fsdmplayer-danmaku-" + e[a].type),
                                ...
                                r >= 0 && (o.classList.add("fsdmplayer-danmaku-move"),
                                u.appendChild(o))
                            }(d);
                ...
                value: function(e) {
                    if (!this.context) {
                        var t = getComputedStyle(this.container.getElementsByClassName("fsdmplayer-danmaku-item")[0], null);
                ...
                key: "resize",
                value: function() {
                    for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("fsdmplayer-danmaku-item"), n = 0; n < t.length; n++)
          ...
          , r = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    case "web":
                        return this.player.container.classList.contains("fsdmplayer-fulled")
                    }
                }
            }, {
                key: "request",
                    ...
                    case "web":
                        ...
                        if (document.pictureInPictureEnabled == true) {
                            if (document.getElementById('enterhzh') != null) {
                                ...
                                // 进入画中画模式时候执行
                                fsdmvideo.addEventListener('enterpictureinpicture', function() {
                                    $('head').append('<style>.fixed{height:0%;}</style>');
                                });
                                fsdmvideo.addEventListener('leavepictureinpicture', function() {
                                    $('head').append('<style>.fixed{height:' + fosi.pmdzd + ';}</style>');
                                });
                            }
                        } else {
        ...
        var a = function() {
          ...
          , r = function() {
            function e(t) {
                i(this, e),
                this.storageName = {
                    opacity: "fsdmplayer-danmaku-opacity",
                    volume: "fsdmplayer-volume",
                    unlimited: "fsdmplayer-danmaku-unlimited",
                    danmaku: "fsdmplayer-danmaku-show",
                    subtitle: "fsdmplayer-subtitle-show"
                },
                this.default = {
                    opacity: .7,
        ...
        var a = function() {
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                key: "show",
                value: function() {
                    this.container.classList.remove("fsdmplayer-subtitle-hide"),
                    this.events.trigger("subtitle_show")
                }
            }, {
                key: "hide",
                value: function() {
                    this.container.classList.add("fsdmplayer-subtitle-hide"),
                    this.events.trigger("subtitle_hide")
                }
            }, {
                key: "toggle",
                value: function() {
                    this.container.classList.contains("fsdmplayer-subtitle-hide") ? this.show() : this.hide()
                }
            }]),
            e
        }();
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.loadingChecker = setInterval(function() {
                        ...
                        i || n !== t || e.player.video.paused || (e.player.container.classList.add("fsdmplayer-loading"),
                        i = !0),
                        i && n > t && !e.player.video.paused && (e.player.container.classList.remove("fsdmplayer-loading"),
                        i = !1),
                        t = n)
                    }, 100)
                }
          ...
          , o = function() {
            function e(t) {
                ...
                this.container.addEventListener("animationend", function() {
                    n.container.classList.remove("fsdmplayer-bezel-transition")
                })
            }
            return a(e, [{
                key: "switch",
                value: function(e) {
                    ...
                    this.container.classList.add("fsdmplayer-bezel-transition")
                }
            }]),
            e
        }();
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = this
                      ...
                      , n = function n() {
                        document.removeEventListener(r.default.nameMap.dragEnd, n),
                        document.removeEventListener(r.default.nameMap.dragMove, t),
                        e.player.template.volumeButton.classList.remove("fsdmplayer-volume-active")
                    };
                    ...
                    this.player.template.volumeBarWrapWrap.addEventListener(r.default.nameMap.dragStart, function() {
                        document.addEventListener(r.default.nameMap.dragMove, t),
                        document.addEventListener(r.default.nameMap.dragEnd, n),
                        e.player.template.volumeButton.classList.add("fsdmplayer-volume-active")
                    }),
                ...
                value: function() {
                    ...
                    this.player.options.video.quality && this.player.template.qualityList.addEventListener("click", function(t) {
                        t.target.classList.contains("fsdmplayer-quality-item") && e.player.switchQuality(t.target.dataset.index)
                    })
                }
            }, {
                ...
                key: "show",
                value: function() {
                    this.player.container.classList.remove("fsdmplayer-hide-controller")
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.container.classList.add("fsdmplayer-hide-controller"),
                ...
                key: "isShow",
                value: function() {
                    return !this.player.container.classList.contains("fsdmplayer-hide-controller")
                }
            }, {
                key: "toggle",
                value: function() {
          ...
          , r = function() {
            function e(t) {
                ...
                this.player.template.speed.addEventListener("click", function() {
                    n.player.template.settingBox.classList.add("fsdmplayer-setting-box-narrow"),
                    n.player.template.settingBox.classList.add("fsdmplayer-setting-box-speed")
                });
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function(e) {
                      ...
                      , r = function e() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.remove("fsdmplayer-setting-danmaku-active")
                    };
                    ...
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener(s.default.nameMap.dragStart, function() {
                        ...
                        n.player.template.danmakuOpacityBox.classList.add("fsdmplayer-setting-danmaku-active")
                    })
                }
            }
            return a(e, [{
                ...
                value: function() {
                    var e = this;
                    this.player.template.settingBox.classList.remove("fsdmplayer-setting-box-open"),
                    this.player.template.mask.classList.remove("fsdmplayer-mask-show"),
                    setTimeout(function() {
                        e.player.template.settingBox.classList.remove("fsdmplayer-setting-box-narrow"),
                        e.player.template.settingBox.classList.remove("fsdmplayer-setting-box-speed")
                    }, 300),
                ...
                key: "show",
                value: function() {
                    this.player.template.settingBox.classList.add("fsdmplayer-setting-box-open"),
                    this.player.template.mask.classList.add("fsdmplayer-mask-show"),
        ...
        var a = function() {
          ...
          , o = function() {
            function e(t) {
                ...
                this.player.template.fsdmcomment.addEventListener("click", function() {
                    n.show()
                }),
            ...
            return a(e, [{
                ...
                value: function() {
                    this.player.controller.disableAutoHide = !0,
                    this.player.template.controller.classList.add("fsdmplayer-controller-comment"),
                    this.player.template.mask.classList.add("fsdmplayer-mask-show"),
                    this.player.container.classList.add("fsdmplayer-show-controller"),
                    this.player.template.commentInput.focus()
                }
            }, {
                key: "hide",
                value: function() {
                    this.player.template.controller.classList.remove("fsdmplayer-controller-comment"),
                    this.player.template.mask.classList.remove("fsdmplayer-mask-show"),
                    this.player.container.classList.remove("fsdmplayer-show-controller"),
                    this.player.controller.disableAutoHide = !1,
                    this.hideSetting()
                }
            }, {
                key: "showSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.add("fsdmplayer-comment-setting-open")
                }
            }, {
                key: "hideSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.remove("fsdmplayer-comment-setting-open")
                }
            }, {
                key: "toggleSetting",
                value: function() {
                    this.player.template.commentSettingBox.classList.contains("fsdmplayer-comment-setting-open") ? this.hideSetting() : this.showSetting()
                }
            }, {
                key: "send",
                value: function() {
                    ...
                    this.player.danmaku.send({
                        ...
                        color: this.player.container.querySelector(".fsdmplayer-comment-setting-color input:checked").value,
                        type: this.player.container.querySelector(".fsdmplayer-comment-setting-type input:checked").value,
                        size: this.player.container.querySelector(".fsdmplayer-comment-setting-font input:checked").value
                    }, function() {
        ...
        var o = function() {
          ...
          , s = function() {
            ...
            return o(e, [{
                key: "show",
                value: function(e, t) {
                    this.player.template.menu.classList.add("fsdmplayer-menu-show");
                ...
                value: function() {
                    this.player.template.mask.classList.remove("fsdmplayer-mask-show"),
                    this.player.template.menu.classList.remove("fsdmplayer-menu-show"),
          ...
          , o = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    this.container.classList.remove("fsdmplayer-info-panel-hide")
                }
            }, {
                key: "hide",
                value: function() {
                    ...
                    this.container.classList.add("fsdmplayer-info-panel-hide")
                }
            }, {
                key: "triggle",
                value: function() {
                    this.container.classList.contains("fsdmplayer-info-panel-hide") ? this.show() : this.hide()
                }
            }, {
                key: "update",
                value: function() {
                    ...
                    this.template.infoVersion.innerHTML = config.contextmenu,
